        ...
        if(empty($D1) & empty($D2) & empty($D1)) {
		 
		 	      $query = "SELECT RRoom_ID, Name, C_ID, Start_date, End_date FROM Booking_info inner join customer on (Booking_info.C_ID=customer.ID_number);";
